        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AutoArchiveDays = table.Column<int>(type: "integer", nullable: false),
                    Created = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    LastModified = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "text", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DayMarkers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DayMarkers_TaskItems_TaskItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DayMarkers_TaskItemId_Date",
                table: "DayMarkers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskHistories_TaskItemId_CreatedAt",
                table: "TaskHistories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskItems_UserId_Archived",
                table: "TaskItems",
